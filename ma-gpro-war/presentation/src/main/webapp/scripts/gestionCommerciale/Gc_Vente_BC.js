...
angular
		...
		.controller(
				...
				[
						...
						'baseUrl',
						'baseUrlGpao',
						function($scope, $http, $filter,$rootScope, $log, downloadService, baseUrlGc,baseUrl,baseUrlGpao) {
...
//							$scope.ListAgent();
							...
							$scope.ofCourant = {};
							$scope.listeProduitOF = [];
							
							$scope.validerOF = function(of) {
                                console.log("-----of----"+of);
                                ...
                                if (of!=null) {
								 ...
								 $http
                                 .get(baseUrlGpao + "/ordreFabrication/getId:"+of)
                                 .success(
                                     function(data) {
                                       //$log.debug("==valider OF == : " + data.length);
                                       
                                       //OFById
                                       $scope.ofCourant = data;
                                       //console.log("-----ofCourant----"+JSON.stringify($scope.ofCourant,null,""));
                                       
                                       //getProduitOF
                                       $http.get(baseUrl+"/produit/getId:"+$scope.ofCourant.produitId).success(
       										function(produit) {
       											
       											//$scope.produitOF = produit;
       											$scope.produitOF = {
       											  "id": produit.id,
       										      ...
       										      "commandeVenteId": "",
       										      "listDetailsProduitCommande": [],
       										      "produitDesignation": produit.designation,
       										      "referenceProduit": produit.reference,
       										      "refCommandeVente": $scope.ofCourant.numero,
       										      "clientAbreviation": produit.partieIntersseDesignation,
       										      "partieIntersseId": produit.partieIntersseId
       											};
       											$scope.listProduitCommande.push($scope.produitOF);
       											
       											
       											//console.log("-----$scope.listProduitCommande--after push--"+JSON.stringify($scope.listProduitCommande,null,""));
           										
       										 $scope.commandeVenteCourante = {
       	                                    	  "id": "",
       	                                    	  "siteId": "",
       	                                    	  "siteDesignation": "",
       	                                    	  "reference": $scope.ofCourant.numero,
       	                                    	  "saison": "",
       	                                    	  "prixTotal": "",
       	                                    	  "dateIntroduction": "",
       	                                    	  "dateLivraison": "",
       	                                    	  "observations": "",
       	                                    	  "partieIntersseId": $scope.ofCourant.partieInterresId,
       	                                    	  "partieIntersseDesignation": $scope.ofCourant.partieInterresAbreviation,
       	                                    	  "typeCommande_id": "",
       	                                    	  "typeCommandeDesignation": "",
       	                                    	  "etatCommande_id": "",
       	                                    	  "etatCommandeDesignation": "",
       	                                    	  "quantite": $scope.ofCourant.quantite,
       	                                    	  "agentId": "",
       	                                    	  "documentCommandeVentes": [],
       	                                    	}
       										
       										//console.log("-----$scope.commandeVenteCourante----"+JSON.stringify($scope.commandeVenteCourante,null,""));

       											
       									});
                                       //$scope.commandeVenteCourante = data
                                  });
                                }
							}
