 ...
 * @since 18/05/2016
 */
public class GammeProduitElementReportValue implements Comparable<GammeProduitElementReportValue>{
	private Long id;
	...
	@Override
	public int compareTo(GammeProduitElementReportValue element) {
