 ...
 *
 */
public class ChaineComptageReportValue {
	...
	private List<ChaineComptageElementReportValue> chaineComptageElementList = new ArrayList<ChaineComptageElementReportValue>();
	...
	public List<ChaineComptageElementReportValue> getChaineComptageElementList() {
		return chaineComptageElementList;
	}

	public void setChaineComptageElementList(
			List<ChaineComptageElementReportValue> chaineComptageElementList) {
		this.chaineComptageElementList = chaineComptageElementList;
	}
