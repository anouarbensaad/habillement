 ...
 *
 */
public class FicheDepartageColisReportValue {
	...
	private List<DetailsColisageValue> colisList = new ArrayList<DetailsColisageValue>();
	...
	public List<DetailsColisageValue> getColisList() {
		return colisList;
	}
	public void setColisList(List<DetailsColisageValue> colisList) {
