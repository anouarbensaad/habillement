...
@Entity
@Table(name=IConstante.TABLE_GP_SECTION)
public class SectionEntity implements Serializable{

	private static final long serialVersionUID = -5792610204010466633L;

	@Id
	@SequenceGenerator(name="SECTION_ID_GENERATOR", sequenceName=IConstante.SEQUENCE_GP_SECTION, allocationSize=1)
