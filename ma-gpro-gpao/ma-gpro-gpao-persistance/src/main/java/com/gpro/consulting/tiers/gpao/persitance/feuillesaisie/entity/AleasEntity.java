 ...
 */
@Entity
@Table(name = IConstante.TABLE_GP_ALEAS)
public class AleasEntity implements Serializable {

	private static final long serialVersionUID = 3299677062564801215L;

	@Id
	@SequenceGenerator(name = "FICHESAISIE_ID_GENERATOR", sequenceName = IConstante.SEQUENCE_GP_ALEAS, allocationSize = 1)
