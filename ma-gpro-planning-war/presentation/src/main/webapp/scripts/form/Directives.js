...
//          element.find('.stepy-navigator').append('<button class="btn btn-primary " ng-click="sauvegarderAjout()">Sauvegarder</button>');
//          element.find('.button-next').after('<button class="button-next" ng-click="sauvegarderAjout()">Sauvegarder</button>');
      }
    }
  })
