				...
				//$log.debug(" ======= after : itemTab : "+JSON.stringify(itemTab,null,"  ")) ;
							...
							$scope.rechercherPlanning = function(
								...
								$http
										.post(
												baseUrlGpao
														+ "/planning/rechercheMulticritere",planningCourant)
										.success(
												function(resultat) {
													$scope.myDataOF = resultat.list;
							...
							$scope.$watch(
								'myDataOF',
									function() {
										...
										{
											field : 'dateFinPrevue',
											displayName : 'Date Fin Prevue',
											cellFilter: 'date:\'dd-MM-yyyy  HH:mm\'',
											width:'12%'
										},
										{
											field : 'dateFinReel',
											displayName : ' Date Fin Reel',
											cellFilter: 'date:\'dd-MM-yyyy  HH:mm\'',
											width:'12%'
										},
										{
