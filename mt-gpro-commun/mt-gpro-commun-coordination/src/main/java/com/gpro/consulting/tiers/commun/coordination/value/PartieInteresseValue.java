 ...
 */
public class PartieInteresseValue implements Comparable<Object>{
  ...
  /** The actif. */
   private Boolean actif;
	...
	/**
	 * @param adresseLiv the adresseLiv to set
	 */
	...
	public int compareTo(Object o) {
		PartieInteresseValue element= (PartieInteresseValue)o;
