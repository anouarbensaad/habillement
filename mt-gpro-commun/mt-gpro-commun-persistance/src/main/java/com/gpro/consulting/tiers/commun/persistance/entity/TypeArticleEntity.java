...
/**
 * The Class TypeArticleEntity.
 * @author $mohamed
 */
@Entity
@Table(name=IConstante.TABLE_TYPE_ARTICLE)
public class TypeArticleEntity implements Serializable {
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -428135062451245120L;

	/** The id. */
	@Id
	@SequenceGenerator(name="TYPE_ARTICLE_ID_GENERATOR", sequenceName = IConstante.SEQUENCE_TYPE_ARTICLE,allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator ="TYPE_ARTICLE_ID_GENERATOR")
	private Long id;
