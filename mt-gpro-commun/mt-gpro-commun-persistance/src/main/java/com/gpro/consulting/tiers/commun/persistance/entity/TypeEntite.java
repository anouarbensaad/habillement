...
/**
 * The Class TypeEntite.
 * 
 * @author $mohamed: $
 */
@Entity
@Table(name = IConstante.TABLE_TYPE_PARTIE_INTERESSEE)
public class TypeEntite implements Serializable {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -3858125661561762535L;

	/** Identifiant technique. */
	/** L'id de la table. */

	@Id
	@SequenceGenerator(name = "TYPE_ID_GENERATOR", sequenceName = IConstante.SEQUENCE_TYPE_PARTIE_INTERESSEE, allocationSize = 1)
