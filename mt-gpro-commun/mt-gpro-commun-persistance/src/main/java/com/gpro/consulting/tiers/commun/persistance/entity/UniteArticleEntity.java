 ...
 */
@Entity
@Table(name=IConstante.TABLE_UNITE)
public class UniteArticleEntity implements Serializable{
	private static final long serialVersionUID = 7748575649552796482L;

	/** The id. */
	@Id
	@SequenceGenerator(name="UNITE_ID_GENERATOR", sequenceName = IConstante.SEQUENCE_UNITE,allocationSize=1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator ="UNITE_ID_GENERATOR")
	private Long id;
