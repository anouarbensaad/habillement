 ...
 */
@Entity
@Table(name = IConstante.TABLE_CATEHGORIE_PARTIE_INTERESSEE)
public class CategorieEntite implements Serializable {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 32368252486599750L;

	/** Identifiant technique. */
	/** L'id de la table. */
	@Id
	@SequenceGenerator(name = "CATEGORIE_ID_GENERATOR", sequenceName = IConstante.SEQUENCE_CATEHGORIE_PARTIE_INTERESSEE, allocationSize = 1)
